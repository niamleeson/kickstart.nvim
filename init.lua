...
vim.keymap.set('n', '<leader>fj', "<cmd>lua require('fzf-lua').grep_curbuf()<CR>", { silent = true, desc = 'Fuzzy current file' })
vim.keymap.set('n', '<leader>fg', "<cmd>lua require('fzf-lua').grep_lcurbuf()<CR>", { silent = true, desc = 'Grep current file' })
